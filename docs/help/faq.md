...
- The Control UI remembers the token in `localStorage` for the selected gateway URL, so refreshes and reopened tabs keep working without re-pasting the token.
