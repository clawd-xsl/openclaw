...
- Set `tools.fs.allowAllHostSendFileTypes=true` if you intentionally want host-local outbound attachment sends to allow any file type the agent can already read, including plain text and Markdown.
