...
export const zh_TW: TranslationMap = {
  ...
  summariesPage: {
    ...
    emptyFallback: "沒有擷取到摘要文字。",
    modelLabel: "模型",
    summaryModelLabel: "摘要模型",
    resultsFound: "找到 {count} 則摘要",
    browseHint: "瀏覽並搜尋過去的會話摘要。",
    sessionKey: "會話鍵",
    sessionKeyPlaceholder: "* 或 agent:main:%",
    queryPlaceholder: "關鍵字搜尋",
    fromLabel: "從",
    fromPlaceholder: "30d 或 2026-01-01",
    toLabel: "到",
    toPlaceholder: "now",
    wildcardHelp: "使用 * 查看所有摘要，並可使用 %subagent% 這類 SQL 風格萬用字元進行比對。",
    noneFound: "找不到摘要。",
    prev: "上一頁",
    next: "下一頁",
    pageOf: "第 {current} 頁，共 {total} 頁",
    missingScope: "目前連線缺少 operator.read，因此暫時無法載入會話摘要。",
  },
  subtitles: {
    agents: "工作區、工具、身份。",
    overview: "狀態、入口點、健康。",
