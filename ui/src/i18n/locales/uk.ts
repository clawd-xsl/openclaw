...
export const uk: TranslationMap = {
  ...
  summaries: {
    toolbar: {
      agent: "Agent",
      agentAria: "Filter summaries by agent",
      defaultAgent: "Агент за замовчуванням",
      searchLabel: "Search",
      searchPlaceholder: "Search summary text and session metadata",
      search: "Search",
      clear: "Clear",
      refresh: "Refresh",
    ...
    states: {
      loadingTitle: "Loading summary history",
      loadingBody: "Fetching the latest session rollover summaries.",
      unavailableTitle: "Summary history unavailable",
      unavailableBody:
        "This gateway does not expose session summary history. Update or enable the summaries backend, then reconnect.",
      errorTitle: "Could not load summary history",
      retry: "Retry",
      emptyTitle: "No session summaries yet",
      emptyBody: "Completed session rollovers will appear here after summary generation begins.",
      noResultsTitle: "No matching summaries",
      noResultsBody: "Try a different search or agent filter.",
    },
    status: {
      pending: "Pending",
      failed: "Failed",
    ...
    card: {
      ...
      pendingSummary: "Summary generation is pending.",
      failedSummary: "Summary generation failed.",
      missingSummary: "No summary text was stored for this session.",
      lastError: "Last error",
    },
    pagination: {
      showing: "Showing {count} summaries",
