...
export const en: TranslationMap = {
  ...
  summariesPage: {
    ...
    emptyFallback: "No summary text captured.",
    modelLabel: "Model",
    summaryModelLabel: "Summary",
    resultsFound: "{count} summaries found",
    browseHint: "Browse and search past session summaries.",
    sessionKey: "Session key",
    sessionKeyPlaceholder: "* or agent:main:%",
    queryPlaceholder: "keyword search",
    fromLabel: "From",
    fromPlaceholder: "30d or 2026-01-01",
    toLabel: "To",
    toPlaceholder: "now",
    wildcardHelp:
      "Use * for all summaries and SQL-style wildcards such as %subagent% for pattern matches.",
    noneFound: "No summaries found.",
    prev: "Prev",
    next: "Next",
    pageOf: "Page {current} of {total}",
    missingScope:
      "This connection is missing operator.read, so session summaries cannot be loaded yet.",
  },
  subtitles: {
    ...
    summaries: "Search saved session catch-up notes.",
