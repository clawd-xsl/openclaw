...
export const zh_CN: TranslationMap = {
  ...
  summariesPage: {
    ...
    emptyFallback: "没有捕获到摘要文本。",
    modelLabel: "模型",
    summaryModelLabel: "摘要模型",
    resultsFound: "找到 {count} 条摘要",
    browseHint: "浏览并搜索过去的会话摘要。",
    sessionKey: "会话键",
    sessionKeyPlaceholder: "* 或 agent:main:%",
    queryPlaceholder: "关键词搜索",
    fromLabel: "从",
    fromPlaceholder: "30d 或 2026-01-01",
    toLabel: "到",
    toPlaceholder: "now",
    wildcardHelp: "使用 * 查看全部摘要，并可使用 %subagent% 这类 SQL 风格通配符进行匹配。",
    noneFound: "未找到摘要。",
    prev: "上一页",
    next: "下一页",
    pageOf: "第 {current} 页，共 {total} 页",
    missingScope: "当前连接缺少 operator.read，因此暂时无法加载会话摘要。",
  },
  subtitles: {
    agents: "工作区、工具、身份。",
    overview: "状态、入口点、健康。",
