...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.session": "Session Summaries",
  ...
  "gateway.cliMcp": "Gateway CLI MCP",
  "gateway.cliMcp.toolSurface": "Gateway CLI MCP Tool Surface",
  ...
  "agents.defaults.untrustedSystemEventsDowngradeSenderIsOwner":
    "Untrusted System Events Downgrade Sender Is Owner",
  ...
  "hooks.mappings[].deleteAfterRun": "Hook Mapping Delete After Run",
