...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.fs.allowAllHostSendFileTypes":
    "Allow any file type for host-local outbound attachments after normal read capability, root, safe-open, and size checks succeed (default: false).",
  ...
  "agents.defaults.compaction.memoryFlush.forceFlushTranscriptBytes":
    'Forces pre-compaction memory flush when transcript file size reaches this threshold (bytes or strings like "2mb"). CLI sessions can flush again after another 2 MiB while this pressure remains active. Set to 0 to disable both transcript-size triggers.',
